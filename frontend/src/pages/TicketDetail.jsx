...
export default function TicketDetail() {
  ...
  const canManage = role === 'responsible' || role === 'admin'
  ...
  const handleSend = () => {
    ...
    const newMsg = {
      id: `m${Date.now()}`,
      sender_type: role === 'admin' ? 'admin' : role === 'responsible' ? 'responsible' : 'user',
      sender_name: role === 'admin' ? 'Administrator' : role === 'responsible' ? 'Andrei Tecuci' : 'Maria Popescu',
